...
namespace {
    jsoncons::json DoGenerateObjectWithSchema(const TypeBasePtr& schema, GeneratorBase* generator);

    jsoncons::json DoGenerateOptional(const TypeBasePtr& schema, GeneratorBase* generator) {
    ...
    jsoncons::json DoGenerateList(const TypeBasePtr& schema, GeneratorBase* generator) {
    ...
    jsoncons::json DoGenerateTuple(const TypeBasePtr& schema, GeneratorBase* generator) {
        std::vector<jsoncons::json> result;
...
ConstForOptionsGenerator::ConstForOptionsGenerator(bool c) : GeneratorBase(), Const_(c) {}

bool ConstForOptionsGenerator::GenerateIsNull() {
    return Const_;
}

std::vector<std::string> GenerateObjectWithSchema(const TypeBasePtr& schema, GeneratorBase* generator, int minSize) {
